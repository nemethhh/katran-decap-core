...
#include "../include/pckt_encap.h"
#include "../include/pckt_parsing.h"
...
/* libxdp multiprog metadata for xdp-loader compatibility */
#include <xdp/xdp_helpers.h>
struct {
  __uint(priority, 10);
  __uint(chain_call_actions, (1 << XDP_PASS));
} XDP_RUN_CONFIG(xdpdecap);
